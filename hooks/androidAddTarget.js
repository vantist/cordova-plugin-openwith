...
function addShareMime(ANDROID_MIME_TYPE) {
  if (ANDROID_MIME_TYPE.startsWith('image/') || ANDROID_MIME_TYPE.startsWith('text/plain')) {
    ...
    console.error(`Unsupported ANDROID_MIME_TYPE, should be [image/* | text/plain | */*], but get ${ANDROID_MIME_TYPE} instead`);
  }
}
